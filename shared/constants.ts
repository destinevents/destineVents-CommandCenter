...
export const STATUS_LABELS: Record<string, string> = { assigned:"Assigned", acknowledged:"Acknowledged", in_progress:"In Progress", completed:"Completed", reviewed:"Reviewed", pending:"Pending", approved:"Approved", rejected:"Rejected" };

export const STATUS_COLORS: Record<string, string> = { assigned:"#6366f1", acknowledged:"#f59e0b", in_progress:"#3b82f6", completed:"#10b981", reviewed:"#8b5cf6", pending:"#f59e0b", approved:"#10b981", rejected:"#ef4444" };
...
export const KANBAN_COLS = ["assigned","acknowledged","in_progress","completed","reviewed"];
