...
export async function savePayroll() {
  ...
  const err = validateRequired(employee_name, 'Employee name');
  if (err) { toast(err, 'error'); return; }
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .total-final{display:flex;justify-content:space-between;font-size:20px;font-weight:700;border-top:2px solid #1a1a1a;padding-top:10px;margin-top:8px}
